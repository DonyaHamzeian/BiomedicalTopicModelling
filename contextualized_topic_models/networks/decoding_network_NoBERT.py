...
from contextualized_topic_models.networks.inference_network_noBERT import NoBERTInferenceNetwork

class DecoderNetworkNoBERT(nn.Module):
    ...
    def __init__(self, input_size, bert_size, infnet, n_components=10, model_type='prodLDA',
        ...
        """
        super(DecoderNetworkNoBERT, self).__init__()
        ...
        if infnet == "zeroshot":
            ...
            self.inf_net = NoBERTInferenceNetwork(
